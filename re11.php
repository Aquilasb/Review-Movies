...
<html>
	...
	<body class="is-preload">
							...
							<div class="wrapper">
								<div class="inner">
									...
									<section>
										...
										<h4>A Entidade</h4>
										<p><span class="image left"><img src="imgs/entidade.jpg" alt="" /></span>A Entidade (no original Sinister), um thriller (suspense/terror) que conta a história de Ellison, um escritor que já teve seus dias de best-seller mas que está em decadência.
										...
										<p><span class="image right"><img src="iages/pic02.jpg" alt="" /></span>Quando Ellison resolve assisti-los, percebe que todos os filmes tratam do mesmo assunto: assassinatos violentos de famílias inteiras, exceto pelo membro mais novo, que sempre desaparecia e nunca mais era encontrado.Ellison passa a investigar e começa também a perceber que coisas estranhas vão acontecendo em sua casa: ruídos, sombras, noites de terror.Ele continua a investigar e, após consultar um policial e um famoso professor conhecedor de ocultismo, ele passa a temer por sua própria família.</p>
									</section>
		...
		<!-- Mudar este item -->		        <input type="hidden" name="id" id= "id" value="11" />
		...
		<!-- Mudar este item -->	
											<?php
											$sql = "SELECT * FROM comentarios where id= 11" ;
